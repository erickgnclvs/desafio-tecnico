 ...
 */
public class PutAtosImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements br.jus.tjsc.www.selo.PutAtos
{
    private static final long serialVersionUID = 1L;
    
    public PutAtosImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ARQUIVO$4 = 
        new javax.xml.namespace.QName("", "arquivo");
    ...
    public byte[] getArquivo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ARQUIVO$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlBase64Binary xgetArquivo()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBase64Binary)get_store().find_element_user(ARQUIVO$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetArquivo()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ARQUIVO$4) != 0;
        }
    }
    ...
    public void setArquivo(byte[] arquivo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ARQUIVO$4);
            }
    ...
    public void xsetArquivo(org.apache.xmlbeans.XmlBase64Binary arquivo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBase64Binary)get_store().add_element_user(ARQUIVO$4);
            }
            target.set(arquivo);
        }
    }
    ...
    public void unsetArquivo()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ARQUIVO$4, 0);
        }
    }
}
